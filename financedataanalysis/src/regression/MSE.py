...
handle = open(MsemodelrrmsePath, 'rb')
msemodelrrmse = pickle.load(handle)
msemodelrrmse['ABT_prices']
mean(msemodelrrmse['ABT_prices'].values())
...
pprint(msemodelurrmse['AAPL_prices'])


dot -n2 -Tpng QME-Graph.gv > QME-Graph.png
